...
<template>
  <div
    ...
    <div class="flex-1 min-w-0 flex flex-col items-start gap-0.5 py-1" :title="titleTooltip">
      <span class="text-sm font-medium text-gray-900 whitespace-nowrap overflow-hidden text-ellipsis w-full">
    ...
    <div class="shrink-0 w-8 flex flex-col items-start py-0.5">
      ...
      <span class="text-xs text-amber-500 font-semibold whitespace-nowrap overflow-hidden text-ellipsis w-full">
        {{ mapping.rawScore }}
      </span>
    </div>
